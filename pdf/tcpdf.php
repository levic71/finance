...
//				$this->SetDrawColor(0, 0, 0);
				...
				//Print page number
				$this->Cell($this->fw-40, $footer_height, $this->l['w_page']." ".$this->PageNo().' / {nb}', 0, 0, 'R'); 

				$this->SetXY($this->original_lMargin+6, $footer_y); 
				
				//Print page number
				$this->Cell($this->fw-40, $footer_height, "http://www.jorkers.com", 0, 0, 'L', 0, "http://www.jorkers.com"); 
			}
		}
