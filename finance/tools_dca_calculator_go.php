...
<div id="dca_calc_form" class="ui container inverted segment form">
    ...
    <h2 class="ui inverted dividing header"><i class="inverted balance scale icon"></i>Rebalancing <?= $portfolio_defined ? "portefeuille ".tools::UTF8_encoding($portfolio_name, 'ISO-8859-1', 'UTF-8') : ( $strategie_defined ? " stratégie ".tools::UTF8_encoding($strategie_name) : "libre") ?></h2>
