...
<div class="ui container inverted segment">
	...
	<?
		...
		echo '<div class="field"><label>&sum; gains réalisés/potentiels</label><input type="text" value="'.sprintf("%.2f&euro;", $portfolio_data['gains_turbos']).' / '.sprintf("%.2f&euro;", $portfolio_data['gains_turbos'] + $portfolio_data['valo_turbos'] - $portfolio_data['invest_turbos']).'" readonly="" /></div>';
