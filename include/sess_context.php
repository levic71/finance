...
class sess_context
{
	...
	public static function isSuperUser() { $sn = strtolower(getenv('SERVER_NAME')); $ra = strtolower(getenv('REMOTE_ADDR')); return ($sn == "localhost" || strtolower($sn) == "r7.jorkers.com" || substr(strtolower($sn), 0, 3) == "r7-" || $rn == "91.164.59.145" || $rn == "127.0.0.1" || $rn == "localhost" ? true : false); }
