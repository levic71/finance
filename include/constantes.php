...
$libelle_track = array(_TRACK_PDF_ => "PDF", _TRACK_AFFICHE_ => "Affiche", _TRACK_SONDAGE_ => "Sondage", _TRACK_ACTUALITE_ => "Actualités", _TRACK_ACCES_HOME_ => "Accès home", _TRACK_ADMIN_ => "Admin", _TRACK_PARTENAIRE_ => "Partenaire", _TRACK_EXPORT_ => "Export");
...
$libelle_phase_finale = array(_PHASE_PLAYOFF_ => "Phase finale", _PHASE_CONSOLANTE1_ => "Matchs de classement/Barrage", _PHASE_CONSOLANTE2_ => "Consolante", _PHASE_FINALE_32_ => "32 ième", _PHASE_FINALE_16_ => "16 ième", _PHASE_FINALE_8_ => "8 ième", _PHASE_FINALE_4_ => "Quart", _PHASE_FINALE_2_ => "Demi", _PHASE_FINALE_ => "Finale");

// Etat d'un joueur
define("_ETAT_JOUEUR_ACTIF_",		0);
define("_ETAT_JOUEUR_BLESSE_",		1);
define("_ETAT_JOUEUR_VACANCES_",	2);
$libelle_etat_joueur = array(_ETAT_JOUEUR_ACTIF_ => "Actif", _ETAT_JOUEUR_BLESSE_ => "Blessé", _ETAT_JOUEUR_VACANCES_ => "En vacances");
...
// Mode de visualisation des journées
...
$libelle_continent = array(_CONTINENT_ALL_ => "International", _CONTINENT_AFRIQUE_ => "Afrique", _CONTINENT_AMERIQUES_ => "Amériques", _CONTINENT_ASIE_ => "Asie", _CONTINENT_EUROPE_ => "Europe", _CONTINENT_OCEANIE_ => "Océanie");
...
$libelle_presence = array(_JOUEUR_REGULIER_ => "Régulier", _JOUEUR_INVITE_ => "Invité");
