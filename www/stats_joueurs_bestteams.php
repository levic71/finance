...
$best_matchs = $sgb->getBestTeams(isset($id_joueur) ? $id_joueur : "");
...
echo "<TR><TD>";
$fxlist = new FXListBestTeams($best_matchs);
$fxlist->FXSetPagination("stats_joueurs_bestteams.php".(isset($id_joueur) ? "?id_joueur=".$id_joueur : ""));
$fxlist->FXDisplay();
echo "</TD>";
