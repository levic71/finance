...
$a_title   = ($modifier == 1) ? $msg['title']   : "{chronique}";
...
<form action="<?= $modifier == 1 ? "gestion_chroniques_modifier_do.php" : "gestion_chroniques_ajouter_do.php" ?>" method="post" enctype="multipart/form-data">
...
$tab[] = array("", "!!! Ne pas enlever {chronique} dans le titre !!!");
$tab[] = array("Message:", "<textarea cols=\"64\" rows=\"20\" id=\"ta\" name=\"ta\">".$a_message."</textarea>");

echo "<tr><td colspan=\"2\">";
$fxlist = new FXListPresentation($tab);
$fxlist->FXSetTitle(($modifier == 1 ? "Modification" : "Ajout")." d'une chronique", "center");
...
function annuler()
{
	document.forms[0].action='gestion_chroniques.php';
