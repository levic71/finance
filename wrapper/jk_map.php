	...
	for (var i = 0; i < data.count; i++) {
		...
		var fn = markerClick(
			'<div class="winmap">'+
				...
				'<div class="access">� <a href="#" onclick="parent.window.location.href=\'<?= $sess_context->isSuperUser() ? "http://localhost:8088/jorkyball/" : "http://'+item.dns+'.jorkers.com/wrapper/" ?>jk.php?idc='+item.id+'\';">Acc�s</a></div>'+
			'</div>', latLng);
