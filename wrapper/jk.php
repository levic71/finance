...
// Empecher la lecture des cookies en javascript pour ̩viter CSS
...
else
{
  if ($sess_context->isUserConnected()) {
    ...
    if ($sess_context->isSuperAdmin()) $sess_context->setAdmin();
    ...
    {
      if ($row2['role'] == _ROLE_ADMIN_ || $row2['role'] == _ROLE_DEPUTY_) $sess_context->setAdmin();
