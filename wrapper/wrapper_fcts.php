...
<h2 class="grid leagues">Statistiques journ�e</h2>
...
public static function string2DNS($str) {
	...
	$name = trim($str, "-");
	$name = trim($name, " ");
	$name = strtr($name, '���������������������������������������������������', 'aaaaaceeeeiiiinooooouuuuyyAAAAACEEEEIIIINOOOOOUUUUY');
	$name = strtr($name, '+.,|!"�$%&/()=?^*簧;:_>][@);', '                             ');
...
public static function textfield_place_form($item) { ?>
	...
	<a href="#" style="float:left;" onclick="choosegooglemap();"><img title="G�olocalisation" src="img/download.png" /></a>
	<label class="mdl-textfield__label" for="<?= $item['id'] ?>"><?= $item['libelle'] ?></label>
<? }
