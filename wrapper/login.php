...
<div class="mdl-card mdl-shadow--6dp mdl-cell mdl-cell--6-col mdl-cell--middle">
	<div class="mdl-card__title mdl-color--primary mdl-color-text--white">
		<h2 class="mdl-cell mdl-cell--12-col mdl-card__title-text mdl-color--primary">Authentification <button id="btforget" class="mdl-button mdl-js-button mdl-button--icon" style="position:absolute; right: 10px;" onclick="mm({action: 'inscription'});"><i class="material-icons">settings</i></button><div class="mdl-tooltip mdl-tooltip--left" for="btforget">Mot de passe oubli� ?</div></h2>
<!-- 
