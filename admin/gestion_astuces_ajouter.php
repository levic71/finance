...
$a_title   = ($modifier == 1) ? $msg['title']   : "{xxx_help}";
...
<form action="<?= $modifier == 1 ? "gestion_astuces_modifier_do.php" : "gestion_astuces_ajouter_do.php" ?>" method="post" enctype="multipart/form-data">
...
$fxlist->FXSetTitle(($modifier == 1 ? "Modification" : "Ajout")." d'une astuce", "center");
...
function annuler()
{
	document.forms[0].action='gestion_astuces.php';
